export default {
    ...
    questions: [{
        ...
        correct: 'Умеете в мемы! Это карта Ангелы Меркель, федерального канцлера Германии. У Ангелы очень много фотографий, на которых она складывает руки в такой ромб.',
