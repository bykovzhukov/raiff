export default {
    ...
    description: '<p>Мы зашифровали 12 личностей в 12 дизайнов карт. Попробуйте угадать, кому они могли бы принадлежать.</p>',
    ...
    questions: [{
        ...
        isDark: true,
        holder: 'Banksy',
        correct: 'Да, это карта Бэнкси. А купюра с принцессой Дианой — одна из их нашумевших работ.',
