export default {
    ...
    questions: [{
        ...
        incorrect: 'К сожалению, нет. На карте предприниматель Ричадр Брэнсон, который мечтает о том, чтобы однажды стерлась граница между его развлечениями на Земле и в космосе.',
        options: [{
            text: 'Ричард Брэнсон',
            isCorrect: true
        }, {
